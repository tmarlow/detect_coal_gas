...
# 2nd number after HOUGH_GRADIENT_ALT = min distance between centers of HoughCircles
...
# ITERATION 3
    circles3 = cv2.HoughCircles(grayM,cv2.HOUGH_GRADIENT_ALT,1,51,
...
# ITERATION 3a
    circles3a = cv2.HoughCircles(grayM,cv2.HOUGH_GRADIENT_ALT,1,81,
...
# ITERATION 4
    circles4 = cv2.HoughCircles(grayL,cv2.HOUGH_GRADIENT_ALT,1,111,
...
# ITERATION 5
    circles5 = cv2.HoughCircles(grayL,cv2.HOUGH_GRADIENT_ALT,1,141,
...
# ITERATION 6
    circles6 = cv2.HoughCircles(grayL,cv2.HOUGH_GRADIENT_ALT,1,170,
...
# ITERATION 1
    circles1 = cv2.HoughCircles(grayL,cv2.HOUGH_GRADIENT_ALT,1,201,
